...
#define DEF_CONFIG_FILE		"./ry_platform_csmj.conf"
...
void CConfig::loadConf()
{
	...
	if (!in)
	{
		LOG(Error, "#error# not find config file:[%s]", DEF_CONFIG_FILE);
	...
	{
		LOG(Error, "#error# config file:[%s] format error!", DEF_CONFIG_FILE);
